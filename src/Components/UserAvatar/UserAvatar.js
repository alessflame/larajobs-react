import { Avatar, Flex, Card,CardHeader,Box, Heading,Text,IconButton,CardBody,ScaleFade } from '@chakra-ui/react'
  ...
  <CardHeader>
    <Flex spacing='4'>
      <Flex flex='1' gap='4' alignItems='center' flexWrap='wrap'>
        <Avatar name='Segun Adebayo' icon={<AiOutlineUser fontSize='1.5rem' />} />
